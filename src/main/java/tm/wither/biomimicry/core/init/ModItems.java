...
public class ModItems {
    ...
    public static final RegistryObject<SwordItem> CACTUS_SPINE = ITEMS.register("cactus_spike",
            () -> new CactusSpineItem(Tiers.STONE, 6, -3.5f, new Item.Properties().durability(584)));
